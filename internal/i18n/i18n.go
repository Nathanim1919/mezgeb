...
func amharic() *Messages {
	return &Messages{
		...
		SellMenuTitle:   "🛒 *ሽያጭ*\n\nምን ማድረግ ይፈልጋሉ?",
		BuyMenuTitle:    "📥 *ግዢ*\n\nምን ማድረግ ይፈልጋሉ?",
		BorrowMenuTitle: "🤝 *ሰው ተበድሮኛል*\n\nምን ማድረግ ይፈልጋሉ?",
		LoanMenuTitle:   "💸 *እኔ ተበድሬያለሁ*\n\nምን ማድረግ ይፈልጋሉ?",
		BtnNewSell:      "➕ አዲስ ሽያጭ",
		BtnListSells:    "📋 የሽያጭ ዝርዝር",
		BtnNewBuy:       "➕ አዲስ ግዢ",
		BtnListBuys:     "📋 የግዢ ዝርዝር",
		BtnNewBorrow:    "➕ አዲስ — ሰው ተበድሮኛል",
		BtnListBorrows:  "📋 የተበደሩኝ ዝርዝር",
		BtnNewLoan:      "➕ አዲስ — እኔ ተበድሬያለሁ",
		BtnListLoans:    "📋 የተበደርኩት ዝርዝር",
		...
		BtnRecordPayment: "💰 ከፍሎኛል",
		BtnRecordRepay:   "💰 ከፍዬዋለሁ",
		BtnPayAll:        "💰 ሙሉ ክፍያ",
		AskPaymentAmount: "💰 ስንት ከፈለዎት?\n\n👤 *%s* — *%s* ይበድርዎታል",
		AskRepayAmount:   "💰 ስንት ከፈሉ?\n\n👤 *%s* — *%s* ይበደራሉ",
		PaymentDone:      "✅ *%s* ከ *%s* ክፍያ ተቀብለዋል\n💰 ቀሪ ዕዳ: *%s*",
		RepayDone:        "✅ ለ *%s* — *%s* ከፍለዋል\n💰 ቀሪ ዕዳ: *%s*",
		PaymentSettled:   "✅ ዕዳ ተወራርዷል! ምንም ቀሪ የለም።",
		AmountExceedsDebt: "⚠️ ከዕዳው በላይ ነው። ቀሪ ዕዳ: *%s*",
		...
		AskBorrowCustomer: "👤 ማን ነው የተበደረዎት? (ስም ያስገቡ)",
		AskBorrowAmount:   "💰 ስንት ብር ተበድሯል?",
		AskBorrowProduct:  "📦 ለየትኛው ምርት? (ወይም ዝለል)",
		AskLoanPerson:     "👤 ከማን ተበደሩ? (ስም ያስገቡ)",
		AskLoanAmount:     "💰 ስንት ብር ተበደሩ?",
		BorrowConfirm:     "✅ *%s* — *%s* ይበድርዎታል",
		LoanConfirm:       "✅ ከ *%s* — *%s* ተበድረዋል",
		BorrowSummaryTitle: "📋 *ሰው ተበድሮኛል — ማጠቃለያ*",
		LoanSummaryTitle:  "📋 *እኔ ተበድሬያለሁ — ማጠቃለያ*",
		...
		TxConfirmDebt:    "✅ *%s* — *%s* ይበድርዎታል",
		TxConfirmPayment: "✅ ከ *%s* — *%s* ክፍያ ተቀብለዋል",
		TxConfirmPurchase: "✅ *%s* — *%s* በ *%s* ገዝቷል",
		...
		ReportBorrowed:    "🤝 ሰዎች የሚበድርዎት: *%s*",
		ReportLoaned:      "💸 እርስዎ የሚበደሩት: *%s*",
